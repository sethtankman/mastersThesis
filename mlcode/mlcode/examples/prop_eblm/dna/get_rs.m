...
plot(sizes,all_rs(:,1)*100,'b-o');
hold on;
plot(sizes,all_rs(:,3)*100,'r-s');
xlabel('Training samples');
ylabel('Avg. prediction accuracy');
legend('w.o rules','w. rules','Location','SouthEast');
%saveas(gcf,'/home/tra161/Downloads/dna_gibbs.png');
hgexport(gcf, '/home/tra161/Downloads/dna_cond.png', hgexport('factorystyle'), 'Format', 'png')