function [model]= kinship_eblm(conf,rules,trn_dat,trn_lab,vld_dat,vld_lab)
...
vis = gibbs_rule_infer(conf,trn_dat,Wr,cv,hidBr,obj_num);
...
%vis(1:2*pred_num,1)
%pause
%vis(2*pred_num+1:4*pred_num,1)
%pause
%vis(4*pred_num+1:6*pred_num,1)
%pause
